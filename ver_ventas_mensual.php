...
$title = "Ver Ventas Total - Farmacia - Luna Systems Peru";
?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="hpanel">
                    <div class="panel-body">
                        <div class="col-md-7 m-b-md">
                            <div class="btn-group">
                                <a href="reg_venta.php" class="btn btn-success"><i class="fa-file-text"></i> Generar Libro Electronico</a>
                            </div>
                        </div>
                        <div class="col-md-5 ">
                        ...
                        <div class="table-responsive">
                            <table id="tabla-ingresos" class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <th width="11%">Tienda</th>
                                    <th width="10%">Total</th>
                                    <th width="10%">Estado</th>
                                    <th width="10%">Estado Doc</th>
                                    <th width="11%">Acciones</th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php
                                $a_ventas = $c_venta->ver_ventas_total();
                                foreach ($a_ventas as $fila) {
                                    ...
                                    if ($fila['estado'] == 1) {
                                        $estado2 = "<label class='label label-success'>Activo</label>";
                                    } else {
                                        $estado2 = "<label class='label label-danger'>Anulado</label>";
                                    }
                                    ?>
                                    <tr>
                                        <td>
                                        ...
                                        <td class="text-center"><?php echo $fila['nombresede'] ?></td>
...
<script>
    ...
    function ver_periodo() {
        window.location.href = 'ver_ventas_mensual.php?periodo=' + $("#select_periodo").val();
    }
