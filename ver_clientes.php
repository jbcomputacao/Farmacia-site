...
$title = "Ver Clientes - Farmacia - Luna Systems Peru";
?>
<!DOCTYPE html>
<html>
<head>
                        ...
                        <table id="tabla-clientes" class="table table-striped table-bordered table-hover">
                            ...
                            foreach ($a_clientes as $fila) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-right"><?php echo $fila['total_venta']?></td>
                                    <td class="text-right"><?php echo $fila['total_pagado']?></td>
                                    <td class="text-center">
                                        <a href="reg_cliente.php?id=<?php echo $fila['id_cliente']?>" class="btn btn-success btn-sm" title="Editar cliente"><i class="fa fa-edit"></i></a>
    ...
    $(function () {
        ...
        $('#tabla-clientes').dataTable({
            ...
            buttons: [
                ...
                {extend: 'csv', title: 'Mis_clientes', className: 'btn-sm'},
                {extend: 'pdf', title: 'Mis_clientes', className: 'btn-sm'},
