                        ...
                        <div class="hpanel">
                            <div class="panel-body">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form class="form-horizontal" method="post"
                                                          action="procesos/reg_presentacion.php">
                                                        <div class="color-line"></div>
                                                        <div class="modal-header text-center">
                                                            <h4 class="modal-title">Agregar Presentacion Producto</h4>
                                                        </div>
                                ...
                                <table id="table-presentaciones" class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                    <?php
                                    $a_documentos = $c_presentacion->ver_presentaciones();
                                    foreach ($a_documentos as $fila) {
                                    ?>
                                        <tr>
                                            <td><?php echo $fila['id_presentacion']?></td>
            ...
            $(function () {
                ...
                $('#table-presentaciones').dataTable({
                    ...
                    buttons: [
                        ...
                        {extend: 'pdf', title: 'Presentaciones', className: 'btn-sm'},
